...
| 06 | GitHub Actions → CodePipeline で自動デプロイ（OIDC + S3 + CodeBuild） | [guide/step06.md](guide/step06.md) |
| 07 | アプリを Node.js から Rails 8.1 へ置き換え（RDS 疎通確認） | [guide/step07.md](guide/step07.md) |
